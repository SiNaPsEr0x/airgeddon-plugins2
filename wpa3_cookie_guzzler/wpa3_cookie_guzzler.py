...
def language_strings():
	...
	arr = {
		...
		("CATALAN", 0): f"{pot}Inicialitzant l'atac Cookie Guzzler...",
		("PORTUGUESE", 0): f"{pot}A inicializar o ataque Cookie Guzzler...",
		("RUSSIAN", 0): f"{pot}Инициализация атаки Cookie Guzzler...",
		("GREEK", 0): f"{pot}Εκκίνηση επίθεσης Cookie Guzzler...",
		("ITALIAN", 0): f"{pot}Inizializzazione dell'attacco Cookie Guzzler...",
		("POLISH", 0): f"{pot}Inicjalizacja ataku Cookie Guzzler...",
		("GERMAN", 0): f"{pot}Initialisierung des Cookie-Guzzler-Angriffs...",
		...
		("CATALAN", 1): f"{pot}Llançant l'atac WPA3 Cookie Guzzler",
		("PORTUGUESE", 1): f"{pot}A lançar o ataque WPA3 Cookie Guzzler",
		("RUSSIAN", 1): f"{pot}Запуск атаки WPA3 Cookie Guzzler",
		("GREEK", 1): f"{pot}Εκκίνηση επίθεσης WPA3 Cookie Guzzler",
		("ITALIAN", 1): f"{pot}Avvio dell'attacco WPA3 Cookie Guzzler",
		("POLISH", 1): f"{pot}Uruchamianie ataku WPA3 Cookie Guzzler",
		("GERMAN", 1): f"{pot}Starte WPA3 Cookie-Guzzler-Angriff",
		...
		("CATALAN", 2): f"{pot}Objectiu: {{bssid}} al canal {{channel}}",
		("PORTUGUESE", 2): f"{pot}Alvo: {{bssid}} no canal {{channel}}",
		("RUSSIAN", 2): f"{pot}Цель: {{bssid}} на канале {{channel}}",
		("GREEK", 2): f"{pot}Στόχος: {{bssid}} στο κανάλι {{channel}}",
		("ITALIAN", 2): f"{pot}Obiettivo: {{bssid}} sul canale {{channel}}",
		("POLISH", 2): f"{pot}Cel: {{bssid}} na kanale {{channel}}",
		("GERMAN", 2): f"{pot}Ziel: {{bssid}} auf Kanal {{channel}}",
		...
		("CATALAN", 3): f"{pot}Iniciant flood Cookie Guzzler a {{interface}}...",
		("PORTUGUESE", 3): f"{pot}Iniciando flood Cookie Guzzler em {{interface}}...",
		("RUSSIAN", 3): f"{pot}Запуск флуд атаки Cookie Guzzler на {{interface}}...",
		("GREEK", 3): f"{pot}Εκκίνηση flood Cookie Guzzler στο {{interface}}...",
		("ITALIAN", 3): f"{pot}Avvio flood Cookie Guzzler su {{interface}}...",
		("POLISH", 3): f"{pot}Rozpoczynanie zalewu Cookie Guzzler na {{interface}}...",
		("GERMAN", 3): f"{pot}Starte Cookie Guzzler Flood auf {{interface}}...",
		...
		("CATALAN", 4): f"{pot}Enviats {{count}} frames...",
		("PORTUGUESE", 4): f"{pot}{{count}} frames enviadas...",
		("RUSSIAN", 4): f"{pot}Отправлено кадров: {{count}}...",
		("GREEK", 4): f"{pot}Εστάλησαν {{count}} frames...",
		("ITALIAN", 4): f"{pot}Inviati {{count}} frame...",
		("POLISH", 4): f"{pot}Wysłano {{count}} ramek...",
		("GERMAN", 4): f"{pot}{{count}} Frames gesendet...",
